  ...
  return (
    ...
    >
      ...
      <div className='w-full flex gap-3 items-center p-5 border-b'>
        <span className='rounded-full h-20 w-20 bg-gradient-to-br from-indigo-500 to-customViolet z-30 flex items-center justify-center text-white text-2xl font-bold'>
          {currentConversation?.partner.name ? getInitials(currentConversation.partner.name) : 'L'}
        </span>
      ...
      <div className='w-full flex items-center border-y border-customViolet/50'>
        ...
        <button 
          type="button" 
          className={`flex gap-2 items-center py-3 px-5 border-customViolet/50 ease-out duration-200 flex-1 justify-center ${
            option === 'files' 
              ? 'bg-customViolet text-white' 
              : 'hover:bg-customViolet/50 focus:bg-customViolet focus:text-white'
          }`}
