...
const ChatHead: React.FC<SetProps> = ({ name, setPage }) => {
  ...
  return (
    <button className='flex__center__all click__action h-24 min-w-20 rounded-md flex-col gap-1 text-xs overflow-hidden outline-none group focus:bg-zinc-100 md:text-base md:min-w-28 md:max-w-28' onClick={() => changePage(9)} >
