...
const NotificationSlip = ({ newNotif, notifType, info, date}: NotificationProps) => {
  return (
    <button className={`w-full grid grid-cols-12 relative pt-3 pb-1 px-5 text-customViolet items-center border-b border-zinc-200 ${newNotif && 'font-semibold'} focus:bg-white click__action text-sm`}>
