...
const DashboardPage = ({ setPage }: ChangePageProps) => {
  ...
  return (
    <div className='max__size px-5 md:px-8 lg:px-12 py-3 md:py-5 text-customViolet lg:text-gray-800 flex flex-col overflow-hidden bg-white lg:bg-gray-50 rounded-t-[1.5rem] lg:rounded-none'>
        ...
        <div className='h-full w-full flex flex-col overflow-x-hidden gap-5 md:gap-6 lg:gap-8 py-3 max-w-7xl mx-auto'>
            ...
            <div className='w-full mt-5 md:mt-6 lg:mt-8 flex__center__y justify-between'>
                <h2 className='h2__style text-xl md:text-2xl lg:text-3xl lg:text-gray-800'>History</h2>
